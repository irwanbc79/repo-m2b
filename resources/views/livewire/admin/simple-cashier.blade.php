<div class="space-y-6">
                    ...
                    <table class="w-full text-xs">
                        ...
                        <td class="px-4 py-3 text-center">
                            ...
                            <div class="flex items-center justify-center gap-1">
                                ...
                                <button wire:click="confirmDelete({{ $trx['id'] }})" class="p-1.5 text-red-600 hover:bg-red-100 rounded-lg transition" title="Hapus">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mt-6">
            ...
            <table wire:key="transactions-{{ $perPage }}-{{ $currentPage }}" class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3">
                    {{-- DEBUG: recentTransactions count = {{ count($recentTransactions) }}, perPage = {{ $perPage }}, currentPage = {{ $currentPage }} --}}
        ...
        <div class="bg-yellow-100 p-2 text-xs">
            PerPage: {{ $perPage }} | CurrentPage: {{ $currentPage }} | TotalRecords: {{ $totalRecords }} | Count: {{ count($recentTransactions) }}
        </div>
        <div class="px-6 py-4 bg-white border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <select wire:model.lazy="perPage" wire:change="changePerPage" class="px-3 py-1.5 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white">
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            ...
            <div class="items-center px-4 py-3 space-y-2">
                <button wire:click="deleteTransaction" class="px-4 py-2 bg-red-600 text-white text-base font-medium rounded-md w-full shadow-sm hover:bg-red-700">Ya, Hapus</button>
