<div class="space-y-6">
    ...
    <div class="flex items-center justify-between bg-blue-50 border border-blue-200 rounded-xl px-4 py-2 text-xs text-blue-900 shadow-sm mb-4">
        <div class="flex items-center gap-2">
            ...
            <span>Menampilkan data & statistik untuk periode: <strong>{{ $activeDateLabel }}</strong> @if($dateFrom && $dateTo)({{ \Carbon\Carbon::parse($dateFrom)->translatedFormat('d M Y') }} &minus; {{ \Carbon\Carbon::parse($dateTo)->translatedFormat('d M Y') }})@endif</span>
        </div>
