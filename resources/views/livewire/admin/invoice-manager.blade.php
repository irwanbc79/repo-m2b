<div class="space-y-6">
    ...
    @php
        ...
        $activeDateLabel = $presetNames[$datePreset] ?? (($dateFrom || $dateTo) ? (($dateFrom ?: '...') . ' s/d ' . ($dateTo ?: '...')) : null);
    @endphp
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2 bg-blue-50 border border-blue-200 rounded-xl px-4 py-2.5 text-xs text-blue-900 shadow-sm mb-4">
        <div class="flex items-center gap-2">
            ...
            <span class="leading-relaxed">Menampilkan data & statistik untuk periode: <strong>{{ $activeDateLabel }}</strong> @if($dateFrom && $dateTo)({{ \Carbon\Carbon::parse($dateFrom)->translatedFormat('d M Y') }} &minus; {{ \Carbon\Carbon::parse($dateTo)->translatedFormat('d M Y') }})@endif</span>
        </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 mb-6">
        ...
        <div wire:click="$set('filterStatus', '')"
             title="{{ number_format($stats['total'] ?? 0) }} Total Invoice"
            ...
            <p class="text-xs font-semibold text-gray-500 mt-0.5">Total Invoice</p>
        </div>
        ...
        <div title="{{ number_format($stats['faktur_pajak_requests'] ?? 0) }} Permintaan Faktur Pajak"
             class="bg-purple-50 rounded-xl p-4 shadow-sm border border-purple-100 text-center relative">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="p-6 border-b border-gray-100 bg-gray-50 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            <div class="flex flex-wrap items-center gap-3">
                ...
                <select wire:model.live="filterCategory" class="border-gray-300 rounded-lg text-sm py-2 px-3 focus:ring-2 focus:ring-blue-500">
            ...
            <div style="position: relative; z-index: 10;" class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-6xl sm:w-full border-t-8 border-blue-900">
                ...
                <div class="bg-white p-8">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
                        ...
                        <div class="lg:col-span-2">
                            <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Shipment Ref (Layanan Milik) <span class="text-gray-400 font-normal normal-case tracking-normal">(opsional)</span></label>
                            <!-- Searchable Dropdown with Alpine.js -->
                            <div wire:ignore x-data="{
                                open: false,
                                search: '',
    ...
    <div x-data="{ show: false, url: '' }" 
        ...
        <div class="bg-white w-full max-w-5xl rounded-xl shadow-2xl flex flex-col" style="height: 90vh;">
            ...
            <div class="p-4 border-b flex justify-between items-center bg-gray-50 rounded-t-xl">
                ...
                <div class="flex items-center gap-2">
                    <button @click="$refs.printFrame.contentWindow.print()" class="bg-blue-900 hover:bg-blue-800 text-white px-4 py-2 rounded-lg font-bold text-sm flex items-center gap-2 shadow-sm transition">
