                    ...
                    <tr class="hover:bg-blue-50/50 transition group cursor-pointer" wire:click="quickView({{ $c->id }})">
                        ...
                        <td class="px-4 py-3 text-center" wire:click.stop>
                            <div class="flex justify-center gap-1">
                                ...
                                @endif
                                <button wire:click="convertToLead({{ $c->id }})"
                                    wire:confirm="Dorong customer ini ke papan MORA Leads untuk di-follow-up sales?"
                                ...
                                <button wire:click="toggleFollowupEmail({{ $c->id }})"
                                    class="p-1.5 rounded-lg transition {{ $c->no_followup_email ? 'text-orange-500 bg-orange-50 hover:bg-orange-100' : 'text-gray-400 hover:text-orange-500 hover:bg-orange-50' }}"
                                    title="{{ $c->no_followup_email ? 'Email follow-up DIBLOKIR — klik untuk aktifkan' : 'Email follow-up aktif — klik untuk blokir' }}">
