<div class="space-y-6">
    ...
    <div class="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-center gap-4">
        <div class="relative flex-1">
            <input wire:model.live="search" type="text" placeholder="Cari No. Shipment, Origin, Destination..." class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-m2b-primary transition">
