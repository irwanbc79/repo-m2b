        ...
        <div class="px-5 py-3 bg-green-50 border-t border-green-100">
            <div class="flex flex-wrap items-center justify-between gap-3">
                ...
                <div class="flex items-center gap-2">
                    @if($hasDoc)
                    <button @click="$dispatch('open-doc-viewer', { url: '{{ Storage::url($qt->signed_document_path) }}', title: 'Dokumen TTD — {{ $qt->quotation_number }}' })"
                        class="inline-flex items-center gap-1 px-3 py-1.5 bg-white border border-emerald-300 text-emerald-700 text-xs font-semibold rounded-lg hover:bg-emerald-50 transition cursor-pointer">
