...
<body class="bg-gray-100 min-h-screen flex items-center justify-center font-sans py-10">
    ...
    <div class="w-full max-w-md bg-white rounded-xl shadow-2xl overflow-hidden m-4 border-t-4 border-m2b-primary">
        ...
        <div class="p-8">
            ...
            <a href="#" class="w-full inline-flex items-center justify-center gap-3 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-bold py-2.5 px-4 rounded-lg shadow-sm hover:shadow transition duration-200 transform hover:-translate-y-0.5">
