...
<div class="max-w-[21cm] mx-auto bg-white p-10 shadow-lg print:shadow-none min-h-[29.7cm] relative {{ !$loop->last ? 'page-break' : '' }} print:p-8">
    ...
    <div class="grid grid-cols-4 gap-4 text-center mt-12">
        ...
        <div class="flex flex-col"><p class="text-xs font-bold mb-2">SUPIR / CARRIER</p><div class="flex-1"></div><p class="border-t border-black mx-2 pt-1">( {{ $container['nama_supir'] ?: '.................' }} )</p></div>
        <div class="flex flex-col"><p class="text-xs font-bold mb-2">SECURITY GUDANG</p><div class="flex-1"></div><p class="border-t border-black mx-2 pt-1">( ................. )</p></div>
        <div class="flex flex-col"><p class="text-xs font-bold mb-2">PENERIMA BARANG</p><div class="flex-1"></div><p class="border-t border-black mx-2 pt-1">( ................. )</p></div>
    </div>
