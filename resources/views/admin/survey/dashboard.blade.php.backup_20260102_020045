...
<head>
    ...
    <title>Survey Dashboard - M2B Admin</title>
    ...
    <div class="min-h-screen">
        ...
        <div class="bg-gray-900 text-white px-6 py-4 flex items-center justify-between">
            <div class="flex items-center space-x-4">
                <a href="{{ route('admin.dashboard') }}" class="text-xl font-bold">M2B <span class="text-red-600">ADMIN</span></a>
                <span class="text-gray-400">|</span>
                <h1 class="text-lg">📊 Survey Dashboard</h1>
            </div>
            <div class="flex items-center space-x-4">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
                    <div class="flex items-center justify-between">
                        <div>
                            <h2 class="text-3xl font-bold text-gray-900">📊 Survey Dashboard</h2>
